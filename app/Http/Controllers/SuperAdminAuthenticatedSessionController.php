...
public function createsuperadmin(Request $request): LoginViewResponse
{
    $userRoleId = 1; // The role ID for "user"
    $userId = Auth::id();
...
public function storesuperadmin(LoginRequest $request)
{
    $credentials = $request->only('email', 'password');
    $userRoleId = 3; // The role ID for "user"
