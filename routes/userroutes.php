...
Route::group(['prefix' => 'user', 'middleware' => config('fortify.middleware', ['web'])], function () {
    $enableViews = config('fortify.views', true);

    // User Authentication...
    if ($enableViews) {
        Route::get(RoutePath::for('user-login', '/login'), [AuthenticatedSessionController::class, 'usercreate'])
    ...
    Route::post(RoutePath::for('user-login', '/login'), [AuthenticatedSessionController::class, 'userstore'])
