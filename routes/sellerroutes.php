...
use App\Http\Controllers\SellerAuthenticatedSessionController;
...
Route::group(['prefix' => 'seller', 'middleware' => config('fortify.middleware', ['web'])], function () {
    $enableViews = config('fortify.views', true);

    // Superadmin Authentication...
    if ($enableViews) {
        Route::get(RoutePath::for('seller-login', '/login'), [SellerAuthenticatedSessionController::class, 'createseller'])
    ...
    Route::post(RoutePath::for('seller-login', '/login'), [SellerAuthenticatedSessionController::class, 'storeseller'])
        ->middleware(array_filter([
            'guest:' . config('fortify.guard'),
            $limiter ? 'throttle:' . $limiter : null,
        ]))
        ->name('seller-formlogin');
