<?php
use App\Http\Controllers\SuperAdminAuthenticatedSessionController;
...
Route::group(['prefix' => 'superadmin', 'middleware' => config('fortify.middleware', ['web'])], function () {
    $enableViews = config('fortify.views', true);

    // Superadmin Authentication...
    if ($enableViews) {
        Route::get(RoutePath::for('superadmin-login', '/login'), [SuperAdminAuthenticatedSessionController::class, 'createsuperadmin'])
    ...
    Route::post(RoutePath::for('superadmin-login', '/login'), [SuperAdminAuthenticatedSessionController::class, 'storesuperadmin'])
        ->middleware(array_filter([
            'guest:'.config('fortify.guard'),
            $limiter ? 'throttle:'.$limiter : null,
        ]))
        ->name('superadmin-formlogin');

    Route::post(RoutePath::for('superadmin-logout', '/logout'), [SuperAuthenticatedSessionController::class, 'destroy'])
